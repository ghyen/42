...
if [ ! -f /var/www/html/wp-config.php ]; then
  ...
  wp core install --url=https://$DOMAIN_NAME --title="gkwon's inception" --admin_user=$ADMIN_NAME --admin_password=$ADMIN_PWD --admin_email=$ADMIN_EMAIL --allow-root --path=/var/www/html/
